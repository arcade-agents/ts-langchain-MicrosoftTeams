...
const TOOLS_WITH_APPROVAL = ['MicrosoftTeams_ReplyToChannelMessage', 'MicrosoftTeams_ReplyToChatMessage', 'MicrosoftTeams_SendMessageToChannel', 'MicrosoftTeams_SendMessageToChat'];
